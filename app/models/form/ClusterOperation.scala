...
object ClusterOperation {
  def apply(operation: String
    ...
    ClusterOperation(operation,ClusterConfig(name, version, zkHosts, zkMaxRetry, jmxEnabled, jmxUser, jmxPass, jmxSsl,
      pollConsumers, filterConsumers, logkafkaEnabled, activeOffsetCacheEnabled, displaySizeEnabled, tuning, securityProtocol, saslMechanism, jaasConfig, bootstrapServers))
  }

  def customUnapply(co: ClusterOperation) : Option[(String, String, String, String, Int, Boolean, Option[String], Option[String], Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Option[ClusterTuning], String, Option[String], Option[String], Option[String])] = {
    Option((co.op.toString, co.clusterConfig.name, co.clusterConfig.version.toString,
            ...
            co.clusterConfig.jaasConfig,co.clusterConfig.bootstrapServers))
  }
}
